...
import 'package:quran/customWidgets/appVersion.dart';
    ...
    return Container(
      ...
      child: ListView(
        children: <Widget>[
          ...
          GuideContainer(
            title: "Guess - Surah Index",
            guideNo: 2,
            guideDescription:
                "Open any Guess, Surah or Sajda directly from index. It has all 30 chapters and 114 surahs." +
          ...
          GuideContainer(
            ...
            guideDescription:
                "Name: Waled Saied \nEmail: waledelsamra@gmail.com \n Website:https://www.facebook.com/WaledElsamra/",
          )
        ],
      ),
    );
